        ...
        <div >
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5>Class {{ $class_name }} - Section {{ $section_name }}</h5> <h5> Total Students: {{ $students->count() }}</h5>
                    <a href="{{ route('students.export-by-class-section', ['udiseCode' => $udise_cd, 'classId' => $class_id, 'sectionId' => $section_id]) }}"
                        ...
                        <table class="table table-hover student-table mb-0">
                            ...
                            @forelse($students as $student)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($student->stud_status == 'E' || $student->stud_Status == 'E')
                                            <span class="badge bg-success">
                                                <i class="fas fa-check-circle me-1"></i>Enrolled
                                            </span>
                                        @elseif($student->stud_status == 'P' || $student->stud_Status == 'P')
