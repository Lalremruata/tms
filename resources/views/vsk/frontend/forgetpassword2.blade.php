                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-8">
                                    ...
                                    @php
                                    function maskFirstThreeCharacters($email) {
                                        ...
                                        if (strlen($name) <= 6) {
                                            ...
                                            $maskedName = str_repeat('*', 6) . substr($name, 6);
                                        }

                                        return $maskedName . '@' . $domain;
                                    }

                                    $maskedEmail = maskFirstThreeCharacters($temp->ema_il);
                                    @endphp
                                    ...
                                    function maskDateOfBirth($dob) {
                                        ...
                                        return $dob; // Return the original date if it is not in the expected format
                                    }

                                    $maskedDob = maskDateOfBirth($temp->dob);
                                    @endphp

                                    <form action="{{route('getforgetpassword')}}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small id="helpId" class="form-text text-muted">{{$maskedEmail}}</small>

                                          </div>

                                          <div class="form-group">
                                            <label for="">DOB</label>
                                            <input type="date" class="form-control" name="dob" id="" aria-describedby="helpId" placeholder="{{ $maskedDob }}" required>
                                            <small id="helpId" class="form-text text-muted">{{$maskedDob}}</small>
                                          </div>
                                        <div class="mt-4">
